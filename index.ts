    ...
    res.send(`
      ...
      <html>
        <head>
          ...
          <meta name="description" content="Komputer kuantum adalah jenis komputer yang menggunakan prinsip mekanika kuantum untuk memproses informasi lebih cepat dari komputer klasik pada kasus tertentu. Pelajari konsep dasar, cara kerja, dan kegunaannya." />
